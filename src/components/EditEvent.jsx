    ...
    return (
      <Container className="page">
        <Alert variant="danger">
          Event not found. Go back to the <Link to="/dashboard">Dashboard</Link>.
        </Alert>
      </Container>
    );
  }
          ...
          {({
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <div className="d-flex flex-wrap gap-3">
                <Form.Group className="mb-3" controlId="editEventDate" style={{ flex: 1, minWidth: 220 }}>
                ...
                <Form.Group className="mb-3" controlId="editEventTime" style={{ flex: 1, minWidth: 220 }}>
